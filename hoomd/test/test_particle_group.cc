...
UP_TEST( ParticleGroup_copy_test )
    ...
    for (unsigned int i = 0; i < pdata->getN(); i++)
        ...
        UPP_ASSERT(tags_all.isMember(i));
        }
...
UP_TEST( ParticleGroup_type_test )
    ...
    UPP_ASSERT_EQUAL_UINT(type0.getNumMembers(), 4);
    ...
    UPP_ASSERT_EQUAL_UINT(type1.getNumMembers(), 2);
    ...
    UPP_ASSERT_EQUAL_UINT(type2.getNumMembers(), 2);
    ...
    UPP_ASSERT_EQUAL_UINT(type3.getNumMembers(), 2);
    ...
    UPP_ASSERT_EQUAL_UINT(alltypes.getNumMembers(), 10);
...
UP_TEST( ParticleGroup_empty_test )
    ...
    UPP_ASSERT_EQUAL_UINT(empty.getNumMembers(), 0);
...
UP_TEST( ParticleGroup_body_test )
    ...
    UPP_ASSERT_EQUAL_UINT(type_true.getNumMembers(), 4);
    ...
    UPP_ASSERT_EQUAL_UINT(type_false.getNumMembers(), 6);
...
UP_TEST( ParticleGroup_tag_test )
    ...
    UPP_ASSERT_EQUAL_UINT(tags05.getNumMembers(), 5);
    ...
    UPP_ASSERT_EQUAL_UINT(tags59.getNumMembers(), 5);
...
UP_TEST( ParticleGroup_cuboid_test )
    ...
    UPP_ASSERT_EQUAL_UINT(tags0.getNumMembers(), 1);
    ...
    UPP_ASSERT_EQUAL_UINT(tags1.getNumMembers(), 2);
    ...
    UPP_ASSERT_EQUAL_UINT(tags2.getNumMembers(), 3);
...
UP_TEST( ParticleGroup_boolean_tests)
    ...
    UPP_ASSERT_EQUAL_UINT(union_group->getNumMembers(), 7);
    ...
    UPP_ASSERT_EQUAL_UINT(intersection_group->getNumMembers(), 2);
