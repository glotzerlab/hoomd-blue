...
class nvt_lj_sphere_energy(unittest.TestCase):
    ...
    def run_statepoint(self, Tstar, rho_star, mean_Uref, sigma_Uref,
                       use_clusters, union):
        """
        ...
        def accumulate_energy(timestep):
            ...
            energy += 8 / 9.0 * math.pi * rho_star * ((1 / rcut)**9 - 3 *
                                                      (1 / rcut)**3)
    ...
    def test_low_density_normal(self):
        self.run_statepoint(Tstar=8.50E-01,
                            rho_star=5.00E-03,
    ...
    def test_moderate_density_normal(self):
        self.run_statepoint(Tstar=9.00E-01,
                            rho_star=7.76E-01,
                            mean_Uref=-5.4689E+00,
                            sigma_Uref=4.20E-04,
                            use_clusters=False,
                            union=False)
