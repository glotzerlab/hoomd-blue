...
/*! \file CurvatureHelfrichMeshForceComputeGPU.cuh
    \brief Declares GPU kernel code for calculating the helfrich forces. Used by
   CurvatureHelfrichMeshForceComputeGPU.
*/

#ifndef __CURVATUREHELFRICHMESHFORCECOMPUTE_CUH__
#define __CURVATUREHELFRICHMESHFORCECOMPUTE_CUH__
