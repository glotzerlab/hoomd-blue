...
template hipError_t gpu_include_rattle_force_bd<ManifoldClassSphere>(const Scalar4 *d_pos,
                                  Scalar4 *d_vel,
                                  Scalar4 *d_net_force,
...
template hipError_t gpu_rattle_langevin_step_two<ManifoldClassSphere>(const Scalar4 *d_pos,
                                  Scalar4 *d_vel,
                                  Scalar3 *d_accel,
                                  const Scalar *d_diameter,
...
template hipError_t gpu_rattle_nve_step_two<ManifoldClassSphere>(Scalar4 *d_pos,
                             Scalar4 *d_vel,
                             Scalar3 *d_accel,
                             unsigned int *d_group_members,
                             const GPUPartition& gpu_partition,
...
template hipError_t gpu_include_rattle_force_nve<ManifoldClassSphere>(const Scalar4 *d_pos,
                             const Scalar4 *d_vel,
                             Scalar3 *d_accel,
                             Scalar4 *d_net_force,
                             Scalar *d_net_virial,
