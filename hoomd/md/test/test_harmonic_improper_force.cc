...
void improper_force_basic_tests(improperforce_creator tf_creator,
    ...
    */
    ...
    fc_8->compute(0);
        ...
        const GPUArray<Scalar4>& force_array_4 = fc_8->getForceArray();
        const GPUArray<Scalar>& virial_array_4 = fc_8->getVirialArray();
    ...
    fc_5->compute(0);
        ...
        {
        const GPUArray<Scalar4>& force_array_5 = fc_5->getForceArray();
        const GPUArray<Scalar>& virial_array_5 = fc_5->getVirialArray();
...
void improper_force_comparison_tests(improperforce_creator tf_creator1,
    ...
    fc2->compute(0);
        ...
        const GPUArray<Scalar4>& force_array_6 = fc1->getForceArray();
        const GPUArray<Scalar>& virial_array_6 = fc1->getVirialArray();
        ArrayHandle<Scalar4> h_force_6(force_array_6, access_location::host, access_mode::read);
        ArrayHandle<Scalar> h_virial_6(virial_array_6, access_location::host, access_mode::read);
        const GPUArray<Scalar4>& force_array_7 = fc2->getForceArray();
        const GPUArray<Scalar>& virial_array_7 = fc2->getVirialArray();
