...
def _manifold_base_params():
    ...
    manifold_base_params_list.extend([paramtuple(cylinder_setup_params,
                                                    cylinder_extra_params,
                                                    cylinder_changed_params,
    ...
    manifold_base_params_list.extend([paramtuple(diamond_setup_params,
                                                    diamond_extra_params,
                                                    diamond_changed_params,
                                                    hoomd.md.manifold.Diamond)])

    ellipsoid_setup_params = {'a': 3.3, 'b': 5, 'c': 4.1 }
    ellipsoid_extra_params = {'P': (0,0,0) }
    ellipsoid_changed_params = {'a': 4, 'b': 2, 'c': 5.2, 'P': (1.0,0,0) }

    manifold_base_params_list.extend([paramtuple(ellipsoid_setup_params,
                                                    ellipsoid_extra_params,
    ...
    manifold_base_params_list.extend([paramtuple(gyroid_setup_params,
                                                    gyroid_extra_params,
                                                    gyroid_changed_params,
                                                    hoomd.md.manifold.Gyroid)])

    primitive_setup_params = {'N': (1,1,1) }
    primitive_extra_params = {'epsilon': 0 }
    primitive_changed_params = {'N': (2,2,2), 'epsilon': -0.1 }

    manifold_base_params_list.extend([paramtuple(primitive_setup_params,
                                                    primitive_extra_params,
                                                    primitive_changed_params,
    ...
    manifold_base_params_list.extend([paramtuple(sphere_setup_params,
                                                    sphere_extra_params,
                                                    sphere_changed_params,
    ...
    manifold_base_params_list.extend([paramtuple(xyplane_setup_params,
                                                    xyplane_extra_params,
                                                    xyplane_changed_params,
...
@pytest.fixture(scope="function", params=_manifold_base_params(), ids=(lambda x: x[3].__name__))
