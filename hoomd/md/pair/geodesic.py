...
class GeodesicPair(Pair):
    ...
    def _attach_hook(self):
        ...
        self._cpp_obj = cls(self._simulation.state._cpp_sys_def, self.nlist._cpp_obj,self.R)


class ExpandedGaussian(GeodesicPair):
    ...
    **Members defined in** `ExpandedGaussian`:
    ...
    _cpp_class_name = "GeodesicPotentialPairExpandedGaussian"
...
class ExpandedLJ(GeodesicPair):
    ...
    **Members defined in** `ExpandedLJ`:
    ...
    _cpp_class_name = "GeodesicPotentialPairExpandedLJ"
    __doc__ = inspect.cleandoc(__doc__).replace(
        "{inherited}", inspect.cleandoc(GeodesicPair._doc_inherited)
    )
...
class Ewald(GeodesicPair):
    ...
    **Members defined in** `Ewald`:
    ...
    _cpp_class_name = "GeodesicPotentialPairEwald"
    __doc__ = inspect.cleandoc(__doc__).replace(
        "{inherited}", inspect.cleandoc(GeodesicPair._doc_inherited)
    )
...
class Table(GeodesicPair):
    ...
    **Members defined in** `Table`:
    ...
    _cpp_class_name = "GeodesicPotentialPairTable"
    __doc__ = inspect.cleandoc(__doc__).replace(
        "{inherited}", inspect.cleandoc(GeodesicPair._doc_inherited)
    )
    _accepted_modes = ("none",)
...
class Morse(GeodesicPair):
    ...
    **Members defined in** `Morse`:
    ...
    _cpp_class_name = "GeodesicPotentialPairMorse"
    __doc__ = inspect.cleandoc(__doc__).replace(
        "{inherited}", inspect.cleandoc(GeodesicPair._doc_inherited)
    )
...
class ForceShiftedLJ(GeodesicPair):
    ...
    **Members defined in** `ForceShiftedLJ`:
    ...
    _cpp_class_name = "GeodesicPotentialPairForceShiftedLJ"
    __doc__ = inspect.cleandoc(__doc__).replace(
        "{inherited}", inspect.cleandoc(GeodesicPair._doc_inherited)
    )
    _accepted_modes = ("none",)
...
class Moliere(GeodesicPair):
    ...
    **Members defined in** `Moliere`:
    ...
    _cpp_class_name = "GeodesicPotentialPairMoliere"
    __doc__ = inspect.cleandoc(__doc__).replace(
        "{inherited}", inspect.cleandoc(GeodesicPair._doc_inherited)
    )
...
class ZBL(GeodesicPair):
    ...
    **Members defined in** `ZBL`:
    ...
    _cpp_class_name = "GeodesicPotentialPairZBL"
    __doc__ = inspect.cleandoc(__doc__).replace(
        "{inherited}", inspect.cleandoc(GeodesicPair._doc_inherited)
    )
    _accepted_modes = ("none",)
...
class Mie(GeodesicPair):
    ...
    **Members defined in** `Mie`:
    ...
    _cpp_class_name = "GeodesicPotentialPairMie"
    __doc__ = inspect.cleandoc(__doc__).replace(
        "{inherited}", inspect.cleandoc(GeodesicPair._doc_inherited)
    )
...
class ExpandedMie(GeodesicPair):
    ...
    **Members defined in** `ExpandedMie`:
    ...
    _cpp_class_name = "GeodesicPotentialPairExpandedMie"
    __doc__ = inspect.cleandoc(__doc__).replace(
        "{inherited}", inspect.cleandoc(GeodesicPair._doc_inherited)
    )
...
class ReactionField(GeodesicPair):
    ...
    **Members defined in** `ReactionField`:
    ...
    _cpp_class_name = "GeodesicPotentialPairReactionField"
    __doc__ = inspect.cleandoc(__doc__).replace(
        "{inherited}", inspect.cleandoc(GeodesicPair._doc_inherited)
    )
...
class Buckingham(GeodesicPair):
    ...
    **Members defined in** `Buckingham`:
    ...
    _cpp_class_name = "GeodesicPotentialPairBuckingham"
    __doc__ = inspect.cleandoc(__doc__).replace(
        "{inherited}", inspect.cleandoc(GeodesicPair._doc_inherited)
    )
...
class LJ1208(GeodesicPair):
    ...
    **Members defined in** `LJ1208`:
    ...
    _cpp_class_name = "GeodesicPotentialPairLJ1208"
    __doc__ = inspect.cleandoc(__doc__).replace(
        "{inherited}", inspect.cleandoc(GeodesicPair._doc_inherited)
    )
...
class LJ0804(GeodesicPair):
    ...
    **Members defined in** `LJ0804`:
    ...
    _cpp_class_name = "GeodesicPotentialPairLJ0804"
    __doc__ = inspect.cleandoc(__doc__).replace(
        "{inherited}", inspect.cleandoc(GeodesicPair._doc_inherited)
    )
...
class Fourier(GeodesicPair):
    ...
    **Members defined in** `Fourier`:
    ...
    _cpp_class_name = "GeodesicPotentialPairFourier"
    __doc__ = inspect.cleandoc(__doc__).replace(
        "{inherited}", inspect.cleandoc(GeodesicPair._doc_inherited)
    )
...
class OPP(GeodesicPair):
    ...
    **Members defined in** `OPP`:
    ...
    _cpp_class_name = "GeodesicPotentialPairOPP"
    __doc__ = inspect.cleandoc(__doc__).replace(
        "{inherited}", inspect.cleandoc(GeodesicPair._doc_inherited)
    )
...
class TWF(GeodesicPair):
    ...
    **Members defined in** `TWF`:
    ...
    _cpp_class_name = "GeodesicPotentialPairTWF"
    __doc__ = inspect.cleandoc(__doc__).replace(
        "{inherited}", inspect.cleandoc(GeodesicPair._doc_inherited)
    )
...
class WangFrenkel(GeodesicPair):
    ...
    **Members defined in** `WangFrenkel`:
    ...
    _cpp_class_name = "GeodesicPotentialPairWangFrenkel"
    __doc__ = inspect.cleandoc(__doc__).replace(
        "{inherited}", inspect.cleandoc(GeodesicPair._doc_inherited)
    )
