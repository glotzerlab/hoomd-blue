...
void export_UpdaterBoxMC()
    ...
    ("UpdaterBoxMC", init< boost::shared_ptr<SystemDefinition>,
                         ...
                         Scalar,
                         const unsigned int >())
    .def("volume_move", &UpdaterBoxMC::volume_move)
    .def("length_move", &UpdaterBoxMC::length_move)
    .def("shear_move", &UpdaterBoxMC::shear_move)
    .def("aspect_move", &UpdaterBoxMC::aspect_move)
