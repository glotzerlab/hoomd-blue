...
void export_BoxDim(pybind11::module& m)
    ...
    pybind11::class_<BoxDim, std::shared_ptr<BoxDim>>(m, "BoxDim")
        ...
        .def("setLDeformationRate", &BoxDim::setLDeformationRate)
        .def("getLDeformationRate", &BoxDim::getLDeformationRate)
        .def("setTiltDeformationRates", &BoxDim::setTiltDeformationRates)
        .def("getTiltDeformationRateXY", &BoxDim::getTiltDeformationRateXY)
        .def("getTiltDeformationRateXZ", &BoxDim::getTiltDeformationRateXZ)
        .def("getTiltDeformationRateYZ", &BoxDim::getTiltDeformationRateYZ)
