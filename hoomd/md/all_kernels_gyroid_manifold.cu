...
template hipError_t gpu_include_rattle_force_nve<ManifoldGyroid>(
		const Scalar4 *d_pos,
                const Scalar4 *d_vel,
                Scalar3 *d_accel,
                Scalar4 *d_net_force,
...
template hipError_t gpu_compute_active_force_constraint_rotational_diffusion<ManifoldGyroid>(
		const unsigned int group_size,
                unsigned int *d_tag,
                unsigned int *d_index_array,
                const Scalar4 *d_pos,
