...
hipError_t gpu_compute_pair_aniso_forces_gb(const a_pair_args_t& pair_args,
            EvaluatorPairGB::param_type* d_param,
            EvaluatorPairGB::shape_type* d_shape_param)
    {
...
hipError_t gpu_compute_pair_aniso_forces_dipole(const a_pair_args_t& pair_args,
            EvaluatorPairDipole::param_type* d_param,
            EvaluatorPairDipole::shape_type* d_shape_param)
    {
...
hipError_t  gpu_compute_pair_aniso_forces_ALJ_2D(const a_pair_args_t& pair_args,
            EvaluatorPairALJ<2>::param_type* d_param,
            EvaluatorPairALJ<2>::shape_type* d_shape_param)
    {
...
hipError_t  gpu_compute_pair_aniso_forces_ALJ_3D(const a_pair_args_t& pair_args,
            EvaluatorPairALJ<3>::param_type* d_param,
            EvaluatorPairALJ<3>::shape_type* d_shape_param)
    {
