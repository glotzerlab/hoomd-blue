...
#ifndef __EVALUATOR_STILLINGERWEBER__
#define __EVALUATOR_STILLINGERWEBER__
...
/*! \file EvaluatorStillingerWeber.h
    \brief Defines the evaluator class for the three-body Stillinger-Weber potential
*/
...
namespace md
    {
//! Class for evaluating the Stillinger-Weber three-body potential
class EvaluatorStillingerWeber
    {
    public:
    ...
    struct param_type
        ...
        Scalar A; //!< Coefficient for the A coefficient in the LJ part of SW potential
        Scalar B; //!< Coefficient for the B coefficient in the LJ part of SW potential
        Scalar epsilon; //!< Coefficient for the epsilon coefficient in the LJ part of SW potential
        Scalar sigma; //!< Coefficient for the sigma coefficient in the LJ part of SW potential
        Scalar q; //!< Coefficient for the q coefficient in the LJ part of SW potential - this is usually 6 in LJ
        Scalar p; //!< Coefficient for the p coefficient in the LJ part of SW potential - this is usually 12 in LJ
        Scalar a; //!< Gives the coefficients in the exponential functions for two body SW part
        Scalar lambda;     //!< Strength of the 3 body term in SW
        Scalar theta;      //!< Angle at which the 3 body term is minimized
        Scalar gamma; //!< Exponent for the 3 body term in SW
...
// CD TODO change the following functions to use new parameter names
#ifndef __HIPCC__
        param_type()
    ...
    */
    DEVICE EvaluatorStillingerWeber(Scalar _rij_sq, Scalar _rcutsq, const param_type& _params)
    ...
    //! The Stillinger-Weber potential needs the bond angle
    ...
    static std::string getName()
        {
        return std::string("stillinger-weber");
        }
