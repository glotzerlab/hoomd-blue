...
/*! \file WallCouplingForceComputeGPU.cu
...
*/
__global__ void gpu_compute_wall_coupling_force_set_forces_kernel(const unsigned int group_size,
...
hipError_t gpu_compute_wall_coupling_force_set_forces(const unsigned int group_size,
    ...
    // run the kernel
    hipLaunchKernelGGL((gpu_compute_wall_coupling_force_set_forces_kernel),
                       dim3(grid),
                       dim3(threads),
                       0,
                       0,
