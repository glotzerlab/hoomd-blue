...
void export_ComputeThermo(py::module& m)
    ...
    .def("getPressureXX", &ComputeThermo::getPressureXX)
    .def("getPressureXY", &ComputeThermo::getPressureXY)
    .def("getPressureXZ", &ComputeThermo::getPressureXZ)
    .def("getPressureYY", &ComputeThermo::getPressureYY)
    .def("getPressureYZ", &ComputeThermo::getPressureYZ)
    .def("getPressureZZ", &ComputeThermo::getPressureZZ)
    .def("getNDOF", &ComputeThermo::getNDOF)
    .def("getTranslationalDOF", &ComputeThermo::getTranslationalDOF)
    .def("getRotationalDOF", &ComputeThermo::getRotationalDOF)
    .def("getNumParticles", &ComputeThermo::getNumParticles)
