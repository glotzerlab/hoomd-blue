...
void export_PotentialPairShoulder(pybind11::module& m);
...
void export_PotentialPairShoulderGPU(pybind11::module& m);
...
PYBIND11_MODULE(_md, m)
    ...
    export_PotentialPairShoulder(m);
    ...
    export_PotentialPairShoulderGPU(m);
