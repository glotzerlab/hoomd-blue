...
template<typename Real, typename Real4, typename Potential> class DEMEvaluator
    {
    public:
    DEMEvaluator(const Potential& potential) : m_potential(potential)
        {
    ...
    Real getRcutSq() const
        {
        return m_potential.getRcutSq();
        }

    Real getRadius() const
        {
        return m_potential.getRadius();
        }
    ...
    */
    ...
    DEVICE inline void comCOM(const Vec& rij,
                              Real& potential,
                              Vec& force_i,
                              Torque& torque_i,
                              Vec& force_j,
    ...
    */
    template<typename Vec, typename Torque>
    DEVICE inline void vertexVertex(const Vec& rij,
                                    const Vec& r0,
                                    const Vec& r1,
                                    Real& potential,
                                    Vec& force_i,
    ...
    */
    template<typename Vec, typename Torque>
    DEVICE inline void vertexEdge(const Vec& rij,
                                  const Vec& r0,
                                  const Vec& r1,
                                  const Vec& r2,
                                  Real& potential,
    ...
    /*! Evaluate the force and torque contributions for particles i
      ...
      for particles i and j will be added to {force, torque}_{i, j}.
    */
    DEVICE inline void vertexFace(const vec3<Real>& rij,
                                  const vec3<Real>& r0,
    ...
    */
    DEVICE inline void edgeEdge(const vec3<Real>& rij,
                                const vec3<Real>& p00,
                                const vec3<Real>& p01,
                                const vec3<Real>& p10,
                                const vec3<Real>& p11,
    ...
    DEVICE static bool needsDiameter()
        {
        return Potential::needsDiameter();
        }
    ...
    DEVICE static bool needsVelocity()
        {
        return Potential::needsVelocity();
        }
