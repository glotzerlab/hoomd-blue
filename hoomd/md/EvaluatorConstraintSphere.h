...
/*! <b>General Overview</b>
    EvaluatorConstraintSphere is a low level computation helper class to aid in evaluating particle
   constraints on a sphere. Given a sphere at a given position and radius, it will find the nearest
   point on the sphere to a given point.
*/
class EvaluatorConstraintSphere
    ...
    */
    DEVICE EvaluatorConstraintSphere(Scalar3 _P, Scalar _r) : P(_P), r(_r) { }
