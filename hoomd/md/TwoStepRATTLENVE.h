...
class PYBIND11_EXPORT TwoStepRATTLENVE : public IntegrationMethodTwoStep
    ...
    public:
        ...
        //! Removes the limit
        void removeLimit(){m_limit = false;}
...
template < class Manifold>
void export_TwoStepRATTLENVE(py::module& m, const std::string& name)
    {
    py::class_<TwoStepRATTLENVE<Manifold>, IntegrationMethodTwoStep, std::shared_ptr<TwoStepRATTLENVE<Manifold> > >(m, name.c_str())
