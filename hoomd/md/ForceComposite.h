...
class PYBIND11_EXPORT ForceComposite : public MolecularForceCompute
    ...
    pybind11::object getBody(std::string body_type)
        ...
        for (unsigned int i = 0; i < N; i++)
            ...
            positions.append(pybind11::make_tuple((Scalar)h_body_pos.data[index].x,
                                                  (Scalar)h_body_pos.data[index].y,
                                                  (Scalar)h_body_pos.data[index].z));
            orientations.append(pybind11::make_tuple((Scalar)h_body_orientation.data[index].x,
                                                     (Scalar)h_body_orientation.data[index].y,
                                                     (Scalar)h_body_orientation.data[index].z,
                                                     (Scalar)h_body_orientation.data[index].w));
