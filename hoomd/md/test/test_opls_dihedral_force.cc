...
void dihedral_force_basic_tests(dihedralforce_creator tf_creator,
    ...
    fc_4->compute(0);
        ...
        {
        const GPUArray<Scalar4>& force_array_1 = fc_4->getForceArray();
        const GPUArray<Scalar>& virial_array_1 = fc_4->getVirialArray();
        size_t pitch = 0;
    ...
    fc_4->compute(1);
        ...
        const GPUArray<Scalar4>& force_array_2 = fc_4->getForceArray();
        const GPUArray<Scalar>& virial_array_2 = fc_4->getVirialArray();
    ...
    fc_4->compute(1);
        ...
        {
        const GPUArray<Scalar4>& force_array_3 = fc_4->getForceArray();
        const GPUArray<Scalar>& virial_array_3 = fc_4->getVirialArray();
    ...
    fc_4->compute(2);
        {
        const GPUArray<Scalar4>& force_array_4 = fc_4->getForceArray();
        const GPUArray<Scalar>& virial_array_4 = fc_4->getVirialArray();
    ...
    fc_4->compute(3);
        ...
        {
        const GPUArray<Scalar4>& force_array_5 = fc_4->getForceArray();
        const GPUArray<Scalar>& virial_array_5 = fc_4->getVirialArray();
    ...
    fc_8->compute(0);
        ...
        const GPUArray<Scalar4>& force_array_6 = fc_8->getForceArray();
        const GPUArray<Scalar>& virial_array_6 = fc_8->getVirialArray();
    ...
    fc_5->compute(0);
        ...
        {
        const GPUArray<Scalar4>& force_array_7 = fc_5->getForceArray();
        const GPUArray<Scalar>& virial_array_7 = fc_5->getVirialArray();
...
void dihedral_force_comparison_tests(dihedralforce_creator tf_creator1,
    ...
    fc2->compute(0);
        ...
        {
        const GPUArray<Scalar4>& force_array_7 = fc1->getForceArray();
        const GPUArray<Scalar>& virial_array_7 = fc1->getVirialArray();
        size_t pitch = virial_array_7.getPitch();
        ArrayHandle<Scalar4> h_force_7(force_array_7, access_location::host, access_mode::read);
        ArrayHandle<Scalar> h_virial_7(virial_array_7, access_location::host, access_mode::read);
        const GPUArray<Scalar4>& force_array_8 = fc2->getForceArray();
        const GPUArray<Scalar>& virial_array_8 = fc2->getVirialArray();
