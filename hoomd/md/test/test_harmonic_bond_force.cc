...
void bond_force_basic_tests(bondforce_creator bf_creator,
    ...
    fc_2->compute(1);
        ...
        const GPUArray<Scalar4>& force_array_2 = fc_2->getForceArray();
        const GPUArray<Scalar>& virial_array_2 = fc_2->getVirialArray();
    ...
    fc_6->compute(0);
        ...
        const GPUArray<Scalar4>& force_array_5 = fc_6->getForceArray();
        const GPUArray<Scalar>& virial_array_5 = fc_6->getVirialArray();
    ...
    fc_4->compute(0);
        ...
        {
        const GPUArray<Scalar4>& force_array_6 = fc_4->getForceArray();
        const GPUArray<Scalar>& virial_array_6 = fc_4->getVirialArray();
