...
class sphere_nec(mode_hpmc):
    ...
    def __init__(self, seed, d=0.1, chain_time=1, update_fraction=0.1, nselect=1, implicit=False, depletant_mode='circumsphere',restore_state=False):
        hoomd.util.print_status_line();
...
class convex_polyhedron_nec(mode_hpmc):
