...
void export_OneDConstraint(py::module& m)
    {
    py::class_<OneDConstraint, ForceConstraint, std::shared_ptr<OneDConstraint>>(m,
                                                                                 "OneDConstraint")
        .def(py::init<std::shared_ptr<SystemDefinition>, std::shared_ptr<ParticleGroup>, Scalar3>())
