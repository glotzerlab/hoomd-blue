...
replacements = {'cudaError_t':'gpu::error_t',
                ...
                'cudaStreamAttachMemAsync':'gpu::streamAttachMemAsync',
                'cudaStreamAttachSingle':'gpu::streamAttachSingle',
                ...
                'cudaSharedMemBankSizeFourByte':'gpu::sharedMemBankSizeFourByte',
                ...
                'cudaFuncCachePreferNone':'gpu::funcCachePreferNone',
                'cudaFuncCachePreferShared':'gpu::funcCachePreferShared',
                'cudaFuncCachePreferL1':'gpu::funcCachePreferL1',
                'cudaFuncCachePreferEqual':'gpu::funcCachePreferEqual',
                'cudaDeviceGetCacheConfig':'gpu::deviceGetCacheConfig',
                ...
                'cudaHostRegister':'gpu::hostRegister',
                'cudaHostRegisterDefault':'gpu::hostRegisterDefault',
                'cudaHostRegisterMapped':'gpu::hostRegisterMapped',
                'cudaHostRegisterPortable':'gpu::hostRegisterPortable',
                'cudaHostRegisterloMemory':'gpu::hostRegisterloMemory',
                'cudaHostUnregister':'gpu::hostUnregister',
                'cudaHostAlloc':'gpu::hostMalloc',
                'cudaHostAllocDefault':'gpu::hostMallocDefault',
                'cudaHostAllocMapped':'gpu::hostMallocMapped',
                ...
                'hipHostRegisterDefault':'gpu::hostRegisterDefault',
                'hipHostRegisterMapped':'gpu::hostRegisterMapped',
                'hipHostRegisterPortable':'gpu::hostRegisterPortable',
                'hipHostRegisterloMemory':'gpu::hostRegisterloMemory',
                ...
                'hipFuncCachePreferNone':'gpu::funcCachePreferNone',
                'hipFuncCachePreferShared':'gpu::funcCachePreferShared',
                'hipFuncCachePreferL1':'gpu::funcCachePreferL1',
                'hipFuncCachePreferEqual':'gpu::funcCachePreferEqual',
                'hipDeviceGetCacheConfig':'gpu::deviceGetCacheConfig',
