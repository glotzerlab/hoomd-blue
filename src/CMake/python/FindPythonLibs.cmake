...
FOREACH(_CURRENT_VERSION 2.6 2.5 2.4 2.3 2.2 2.1 2.0 1.6 1.5)
  ...
  ENDIF(WIN32)
	...
	set(_python_libs_dir_suffixes " ")

    IF( PythonLibs_USE_STATIC_LIBS )
      SET( _python_libs_ORIG_CMAKE_FIND_LIBRARY_SUFFIXES ${CMAKE_FIND_LIBRARY_SUFFIXES})
      IF(WIN32)
        SET(CMAKE_FIND_LIBRARY_SUFFIXES .lib .a)
      ELSE(WIN32)
        SET(CMAKE_FIND_LIBRARY_SUFFIXES .a)
		set(_python_libs_dir_suffixes "python${_CURRENT_VERSION}/config")
      ENDIF(WIN32)
    ENDIF( PythonLibs_USE_STATIC_LIBS )

  FIND_LIBRARY(PYTHON_LIBRARY
    NAMES python${_CURRENT_VERSION_NO_DOTS} python${_CURRENT_VERSION}
	HINTS ${PYTHON_ROOT}
	PATH_SUFFIXES ${_python_libs_dir_suffixes}
	PATHS
      [HKEY_LOCAL_MACHINE\\SOFTWARE\\Python\\PythonCore\\${_CURRENT_VERSION}\\InstallPath]/libs
  )
    IF( PythonLibs_USE_STATIC_LIBS )
      SET(CMAKE_FIND_LIBRARY_SUFFIXES ${_python_libs_ORIG_CMAKE_FIND_LIBRARY_SUFFIXES})
    ENDIF( PythonLibs_USE_STATIC_LIBS )
