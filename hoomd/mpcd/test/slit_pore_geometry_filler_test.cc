...
template<class F>
void slit_pore_fill_basic_test(std::shared_ptr<ExecutionConfiguration> exec_conf)
    {
     ...
     * The width of the bottom is 2, since the wall slices halfway through the cell. The area is the
