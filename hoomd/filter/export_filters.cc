...
void export_ParticleFilters(pybind11::module& m)
    {
    pybind11::class_<ParticleFilter,
                    std::shared_ptr<ParticleFilter> >(m,"ParticleFilter")
            .def(pybind11::init< >())
            .def("_get_selected_tags", &ParticleFilter::getSelectedTags);

    pybind11::class_<ParticleFilterSetDifference, ParticleFilter,
    ...
    pybind11::class_<ParticleFilterUnion, ParticleFilter,
                    std::shared_ptr<ParticleFilterUnion>
                   >(m, "ParticleFilterUnion")
            .def(pybind11::init<std::shared_ptr<ParticleFilter>,
                                std::shared_ptr<ParticleFilter> >());

    pybind11::class_<ParticleFilterType, ParticleFilter,
                    std::shared_ptr<ParticleFilterType>
