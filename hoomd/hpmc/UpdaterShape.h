...
void export_UpdaterShape(pybind11::module& m, const std::string& name)
    ...
    .def_property("move_ratio", &UpdaterShape<Shape>::getMoveRatio, &UpdaterShape<Shape>::setMoveRatio)
    ...
    .def_property("multi_phase", &UpdaterShape<Shape>::getMultiPhase, &UpdaterShape<Shape>::setMultiPhase)
    .def_property("num_phase", &UpdaterShape<Shape>::getNumPhase, &UpdaterShape<Shape>::setNumPhase)
    ;
    }
