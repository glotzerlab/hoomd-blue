...
void hoomd::md::export_wall_field(pybind11::module& m)
    ...
    export_array_view<hoomd::md::SphereWall>(m, "SphereArray");
    export_array_view<hoomd::md::CylinderWall>(m, "CylinderArray");
    export_array_view<hoomd::md::PlaneWall>(m, "PlaneArray");
        ...
        .def("get_sphere_list",
             [](hoomd::md::wall_type& wall_list)
             {
                 return make_array_view(
                     ...
                     std::function<void(const array_view<hoomd::md::SphereWall>*)>(
                         [&wall_list](const array_view<hoomd::md::SphereWall>* view) -> void
        ...
        .def("get_cylinder_list",
             [](hoomd::md::wall_type& wall_list)
             {
                 return make_array_view(
                     ...
                     std::function<void(const array_view<hoomd::md::CylinderWall>*)>(
                         [&wall_list](const array_view<hoomd::md::CylinderWall>* view) -> void
        ...
        .def("get_plane_list",
             [](hoomd::md::wall_type& wall_list)
             {
                 return make_array_view(
                     ...
                     MAX_N_PWALLS,
                     wall_list.numPlanes,
                     std::function<void(const array_view<hoomd::md::PlaneWall>*)>(
                         [&wall_list](const array_view<hoomd::md::PlaneWall>* view) -> void
