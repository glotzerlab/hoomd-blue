...
# 4) set TEST_GROUP to "Experimental" and run ctest -S ctest_hoomd.cmake to check that the test runs
#     the results of the test should show up at: http://my.cdash.org/index.php?project=HOOMD
# 5) chate TEST_GROUP back to "Nightly" and set ctest command line above to run every day

# **MODIFY THIS (location where hoomd src and bin directory are)
SET (CTEST_SOURCE_DIRECTORY "$ENV{HOME}/hoomd/src")
SET (CTEST_BINARY_DIRECTORY "$ENV{HOMD}/hoomd/bin_dbg")
...
SET (CTEST_COMMAND "ctest -D ${TEST_GROUP}")
...
SET (BUILDNAME "${CMAKE_SYSTEM_NAME}-${COMPILER_NAME}-${HOOMD_BRANCH}")
...
# setup for parallel builds with make
