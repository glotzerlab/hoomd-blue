...
/*! \file ForceComposite.h
    ...
    Nested rigid bodies are not supported, i.e. when a rigid body contains a rigid body ptl of
   another type.
...
class PYBIND11_EXPORT ForceComposite : public MolecularForceCompute
    ...
    //! Update the constituent particles of a composite particle using the position, velocity and
    ...
    /*! \param create If true, expand central particle types into rigid bodies, modifying the number
     * of particles
     */
