...
shape_list = [
    ...
    ("polyhedron", {"vertices": [[-1,-1,-1],
                                 ...
                                 [1,1,1],
                                 [1,1,-1]],
                                 "sweep_radius": 0, "ignore_statistics": True}),
    # deformed cubed
    ("polyhedron", {"vertices": [[-1.00010558, -1.05498028, -1.02785711],
    ...
    ("polyhedron", {"vertices":[[-1.38818127, -0.43327022,  0.48655642],
                                ...
                                "sweep_radius": 0, "ignore_statistics": True}),
    ("ellipsoid", {"a": 1, "b": 1, "c": 1, "ignore_statistics": True}),
    ("ellipsoid", {"a": 1, "b": 1, "c": 2, "ignore_statistics": True}),
    ("ellipsoid", {"a": 1.5, "b": 1, "c": 1, "ignore_statistics": True}),
    ("ellipsoid", {"a": 1, "b": 0.8, "c": 1, "ignore_statistics": True}),
    ("ellipsoid", {"a": 1.3, "b": 2.7, "c": 0.7, "ignore_statistics": True}),
]

volume_list = [8.0, 9.906613237811571, 2.5813333333333337, 3.406051603090999,
               4.1887902047863905, 8.377580409572781, 6.283185307179586,
               3.3510321638291125, 10.291857533160162]


det_moi_list = [151.70370370370372, 433.6939933469258, 0.873927553653835,
                2.754115599932528, 4.70376701046326, 235.18835052316288,
                41.920486071765346, 1.6193602241717742, 1328.2618881466828]
