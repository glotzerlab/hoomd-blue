...
void periodic_force_particle_test(periodicforce_creator periodic_creator, std::shared_ptr<ExecutionConfiguration> exec_conf)
    ...
    fc_3->setParams(0, PotentialExternalPeriodic::param_type(index, orderParameter,
                interfaceWidth, periodicity));
    fc_3->setParams(1, PotentialExternalPeriodic::param_type(index, -orderParameter,
                interfaceWidth, periodicity));
