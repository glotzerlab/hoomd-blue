...
//! Pair potential force compute for shifted Mie potential
typedef PotentialPair<EvaluatorPairSMie> PotentialPairSMie;
...
typedef PotentialPairGPU<EvaluatorPairSMie, gpu_compute_smie_forces> PotentialPairSMieGPU;
