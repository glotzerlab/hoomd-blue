...
#ifndef __PAIR_ELEMENT_MODULATOR_H__
#define __PAIR_ELEMENT_MODULATOR_H__
...
*/
template<typename PairEvaluator, typename DirectionalEnvelope> class PairElementModulator
    {
    public:
    struct param_type
        {
    ...
    */
    DEVICE PairElementModulator(const Scalar3& _dr,
                         const Scalar4& _q_i,
                         const Scalar4& _q_j,
