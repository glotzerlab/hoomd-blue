...
typedef PotentialExternal<EvaluatorWalls<EvaluatorPairSMie> > WallsPotentialSMie;
...
typedef PotentialExternalGPU<EvaluatorWalls<EvaluatorPairSMie> > WallsPotentialSMieGPU;
