...
Release tarballs are also available as `GitHub release`_ assets: `Download hoomd-v3.4.0.tar.gz`_.
...
.. _Download hoomd-v3.4.0.tar.gz: https://github.com/glotzerlab/hoomd-blue/releases/download/v3.4.0/hoomd-v3.4.0.tar.gz
