...
class LJ(_Pair):
    ...
    Args:
        nlist (hoomd.md.nlist._Nlist): Neighbor list
...
class table(force._force):
    ...
    Args:
        ...
        nlist (hoomd.md.nlist._Nlist): Neighbor list (default of None automatically creates a global cell-list based neighbor list)
