...
DEVICE bool ManifoldClassGyroid::validate(const BoxDim box)
{
...
void export_ManifoldClassGyroid(pybind11::module& m)
    {
    py::class_< ManifoldClassGyroid, std::shared_ptr<ManifoldClassGyroid> >(m, "ManifoldClassGyroid")
    .def(py::init<int, int, int, Scalar >())
    .def("implicit_function", &ManifoldClassGyroid::implicit_function)
    .def("derivative", &ManifoldClassGyroid::derivative)
    ;
    }
