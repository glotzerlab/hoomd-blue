...
class external_field_lattice(unittest.TestCase):
    ...
    def run_test(self, latticep, latticeq, k, kalt, q, qalt, uein, snapshot_s, eng_check):
        ...
        if uein:
            ...
            self.mc.set_params(d=0.0001, a=0.00001);
    ...
    def test_lattice(self):
        ...
        self.run_test(latticep=lattice3d, latticeq=[], k=k, kalt=kalt, q=0, qalt=0, uein=1.5, snapshot_s=self.snapshot3d_s, eng_check=eng_check3d);
        self.tear_down()
        ...
        self.run_test(latticep=lattice3d, latticeq=latticeq, k=k, kalt=kalt, q=k*10.0, qalt=kalt*10.0, uein=3.0, snapshot_s=self.snapshot3d_s, eng_check=(eng_check3d+eng_checkq));
        self.tear_down()
        ...
        self.run_test(latticep=lattice2d, latticeq=latticeq, k=k, kalt=kalt, q=k*10.0, qalt=kalt*10.0, uein=1.5, snapshot_s=self.snapshot2d_s, eng_check=(eng_check2d+eng_checkq));
        self.tear_down()
