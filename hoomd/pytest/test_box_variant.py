...
valid_constructors = [
    ...
    (hoomd.variant.box.Interpolate, {
        'initial_box': _test_box1,
        'final_box': _test_box2,
        'variant': _test_scalar_variant1
    }),
    (hoomd.variant.box.InverseVolumeRamp, {
        'initial_box': _test_box2,
        'final_volume': 1000,
        't_start': 10,
        't_ramp': 50
    }),
...
valid_attrs = [
    (hoomd.variant.box.Constant, {
        'box': [_test_box1, _test_box2]
    }),
    (hoomd.variant.box.Interpolate, {
        'initial_box': [_test_box1, _test_box2],
        'final_box': [_test_box2, _test_box1],
        'variant': [_test_scalar_variant1, _test_scalar_variant2]
    }),
    (hoomd.variant.box.InverseVolumeRamp, {
        'initial_box': [_test_box1, _test_box2],
...
def test_custom():
    ...
    test_box = hoomd.Box(_test_box1.Lx, _test_box1.Ly, _test_box1.Lz,
...
def test_interpolate_evaluation():
    ...
    box_variant = hoomd.variant.box.Interpolate(_test_box1, _test_box2,
                                                scalar_variant)
