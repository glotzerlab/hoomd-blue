...
template void hpmc_cluster_overlaps<ShapeUnion<ShapeSpheropolyhedron> >(const cluster_args_t& args, const ShapeUnion<ShapeSpheropolyhedron>::param_type *params);
//! Kernel driver for kernel::clusters_depletants
template void hpmc_clusters_depletants<ShapeUnion<ShapeSpheropolyhedron> >(const cluster_args_t& args, const hpmc_implicit_args_t& implicit_args, const ShapeUnion<ShapeSpheropolyhedron>::param_type *params);
//! Driver for kernel::transform_particles
template void transform_particles<ShapeUnion<ShapeSpheropolyhedron> >(const clusters_transform_args_t& args, const ShapeUnion<ShapeSpheropolyhedron>::param_type *params);
}
