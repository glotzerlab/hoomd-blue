...
def test_values(simulation_factory, lattice_snapshot_factory):
    ...
    sim.operations.writers.append(
        hoomd.write.CustomWriter(action=sdf_log, trigger=hoomd.trigger.Periodic(10))
    )
...
def test_logging():
    logging_check(
        ...
        ("hpmc", "compute"),
        {
            "betaP": {"category": LoggerCategories.scalar, "default": True},
            "sdf_compression": {"category": LoggerCategories.sequence, "default": True},
            "sdf_expansion": {"category": LoggerCategories.sequence, "default": True},
            "x_compression": {"category": LoggerCategories.sequence, "default": True},
            "x_expansion": {"category": LoggerCategories.sequence, "default": True},
        },
    )
