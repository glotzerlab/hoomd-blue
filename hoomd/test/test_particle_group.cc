...
UP_TEST( ParticleGroup_copy_test )
    ...
    std::shared_ptr<ParticleSelector> selector_all(new ParticleSelectorTag(0, pdata->getN()-1));
...
UP_TEST( ParticleGroup_sort_test )
    ...
    std::shared_ptr<ParticleSelector> selector04(new ParticleSelectorTag(0, 4));
...
UP_TEST( ParticleGroup_type_test )
    ...
    std::shared_ptr<ParticleSelector> selector0(new ParticleSelectorType(0, 0));
    ...
    std::shared_ptr<ParticleSelector> selector1(new ParticleSelectorType(1, 1));
    ...
    std::shared_ptr<ParticleSelector> selector2(new ParticleSelectorType(2, 2));
    ...
    std::shared_ptr<ParticleSelector> selector3(new ParticleSelectorType(3, 3));
    ...
    std::shared_ptr<ParticleSelector> selector_all(new ParticleSelectorType(0, 3));
...
UP_TEST( ParticleGroup_empty_test )
    ...
    std::shared_ptr<ParticleSelector> selector100(new ParticleSelectorType(100, 100));
...
UP_TEST( ParticleGroup_body_test )
    ...
    std::shared_ptr<ParticleSelector> selector_body_true(new ParticleSelectorRigid(true));
    ...
    std::shared_ptr<ParticleSelector> selector_body_false(new ParticleSelectorRigid(false));
...
UP_TEST( ParticleGroup_tag_test )
    ...
    std::shared_ptr<ParticleSelector> selector59(new ParticleSelectorTag(5, 9));
...
UP_TEST( ParticleGroup_cuboid_test )
    ...
    std::shared_ptr<ParticleSelector> selector0(new ParticleSelectorCuboid(make_scalar3(-0.5, -0.5, -0.5),
    ...
    std::shared_ptr<ParticleSelector> selector1(new ParticleSelectorCuboid(make_scalar3(-0.5, -0.5, -0.5),
    ...
    std::shared_ptr<ParticleSelector> selector2(new ParticleSelectorCuboid(make_scalar3(-1.5, -2.5, -3.5),
                                                                           make_scalar3( 1.5,  2.5,  3.5)));
...
UP_TEST( ParticleGroup_total_mass_tests)
    ...
    ParticleGroup group1(sysdef, std::shared_ptr<ParticleSelector>(new ParticleSelectorTag(0, 0)));
    MY_CHECK_CLOSE(group1.getTotalMass(), 1.0, tol);

    ParticleGroup group2(sysdef, std::shared_ptr<ParticleSelector>(new ParticleSelectorTag(0, 1)));
    MY_CHECK_CLOSE(group2.getTotalMass(), 3.0, tol);

    ParticleGroup group3(sysdef, std::shared_ptr<ParticleSelector>(new ParticleSelectorTag(0, 2)));
