...
#ifndef __PAIR_EVALUATOR_ROTATION_COUPLING_H__
#define __PAIR_EVALUATOR_ROTATION_COUPLING_H__
...
namespace md
    {
class EvaluatorPairRotationCoupling
    {
    public:
    struct param_type
        {
    ...
    */
    HOSTDEVICE EvaluatorPairRotationCoupling(Scalar3& _dr,
                                             Scalar4& _quat_i,
                                             Scalar4& _quat_j,
                                             Scalar _rcutsq,
                                             const param_type& _params)
        : dr(_dr), rcutsq(_rcutsq), quat_i(_quat_i), quat_j(_quat_j), ang_mom {0, 0, 0},
          kappa(_params.kappa), tau(_params.tau)
        {
        }
    ...
    */
    HOSTDEVICE void setDiameter(Scalar di, Scalar dj) {diameter = 0.5 * (di + dj)}
    ...
    */
    HOSTDEVICE bool evaluate(Scalar3& force,
        ...
        vec3<Scalar> f = kappa * prefactor * cross(dr, ang_mom) * rinv;
