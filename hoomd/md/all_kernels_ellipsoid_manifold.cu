...
namespace kernel
    {
template hipError_t
gpu_rattle_brownian_step_one<ManifoldEllipsoid>(Scalar4* d_pos,
                                                int3* d_image,
                                                Scalar4* d_vel,
                                                const BoxDim& box,
...
template hipError_t
gpu_include_rattle_force_bd<ManifoldEllipsoid>(const Scalar4* d_pos,
                                               Scalar4* d_net_force,
                                               Scalar* d_net_virial,
                                               const Scalar* d_diameter,
                                               const unsigned int* d_tag,
...
template hipError_t gpu_rattle_langevin_step_two<ManifoldEllipsoid>(
    const Scalar4* d_pos,
    Scalar4* d_vel,
    Scalar3* d_accel,
    const Scalar* d_diameter,
