...
void export_VectorVariantBox(pybind11::module& m)
    ...
    pybind11::class_<VectorVariantBoxLinear,
        ...
        .def_property("initial_box", &VectorVariantBoxLinear::getBox1, &VectorVariantBoxLinear::setBox1)
        .def_property("final_box", &VectorVariantBoxLinear::getBox2, &VectorVariantBoxLinear::setBox2)
