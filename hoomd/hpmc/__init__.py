...
orientations. HPMC updaters `hoomd.hpmc.update` interoperate with the integrator
to perform additional types of trial moves, including box moves, cluster moves,
and particle insertion/removal. Use HPMC computes `hoomd.hpmc.compute` to
compute properties of the system state, such as the free volume or pressure.
"""
