...
template hipError_t
gpu_include_rattle_force_bd<ManifoldXYPlane>(const Scalar4* d_pos,
                                             Scalar4* d_net_force,
                                             Scalar* d_net_virial,
                                             const Scalar* d_diameter,
                                             const unsigned int* d_tag,
...
template hipError_t gpu_rattle_langevin_step_two<ManifoldXYPlane>(
    const Scalar4* d_pos,
    Scalar4* d_vel,
    Scalar3* d_accel,
    const Scalar* d_diameter,
...
template hipError_t gpu_compute_active_force_constraint_rotational_diffusion<ManifoldXYPlane>(
    const unsigned int group_size,
    unsigned int* d_tag,
    unsigned int* d_index_array,
    const Scalar4* d_pos,
