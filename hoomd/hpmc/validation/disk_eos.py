...
class diskEOS_test(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.log.register_callback(
            'phi_p', lambda timestep: len(self.system.particles) / self.system.
            box.get_volume() * math.pi / 4.0)
    ...
    def test_measure_phi_p(self):
        ...
        self.assertLessEqual(math.fabs(phi_p_avg - phi_p_ref),
                             ci * (phi_p_ref * rel_err_cs + phi_p_err))
