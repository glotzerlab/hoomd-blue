...
/*! \param sysdef SystemDefinition containing the ParticleData to compute forces on
    ...
    \note This class doesn't actually do anything with the particle data. It just returns a constant
   force
*/
ConstExternalFieldDipoleForceCompute::ConstExternalFieldDipoleForceCompute(
...
*/
void ConstExternalFieldDipoleForceCompute::setParams(Scalar field_x,
                                                     Scalar field_y,
                                                     Scalar field_z,
                                                     Scalar p)
    {
...
void export_ConstExternalFieldDipoleForceCompute(py::module& m)
    {
    py::class_<ConstExternalFieldDipoleForceCompute,
               ForceCompute,
               std::shared_ptr<ConstExternalFieldDipoleForceCompute>>(
        m,
