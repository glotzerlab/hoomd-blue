...
class sphereEOS_nec_test(unittest.TestCase):
    ...
    def setUp(self):
        ...
        for i in range(10):
            ...
            if comm.get_rank() == 0:
                print('d: {:3.2f} accept: {:3.2f} / v: {:3.2f} accept: {:3.2f} / ct: {:3.5f} nc: {:3.5f}'.format(d,translate_acceptance,v,volume_acceptance, self.mc.get_chain_time(), self.mc.get_particles_per_chain() ));
...
class sphereEOS_nec_test_noncubic(sphereEOS_nec_test):
    n = [7, 8, 6]
