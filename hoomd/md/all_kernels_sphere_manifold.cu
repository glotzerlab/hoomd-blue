...
template hipError_t gpu_rattle_brownian_step_one<ManifoldSphere>(Scalar4 *d_pos,
                                  int3 *d_image,
                                  Scalar4 *d_vel,
                                  const BoxDim& box,
...
template hipError_t gpu_include_rattle_force_bd<ManifoldSphere>(const Scalar4 *d_pos,
                                  Scalar4 *d_net_force,
                                  Scalar *d_net_virial,
                                  const Scalar *d_diameter,
                                  const unsigned int *d_tag,
...
template hipError_t gpu_rattle_langevin_step_two<ManifoldSphere>(const Scalar4 *d_pos,
                                  Scalar4 *d_vel,
                                  Scalar3 *d_accel,
                                  const Scalar *d_diameter,
                                  const unsigned int *d_tag,
...
template hipError_t gpu_rattle_nve_step_two<ManifoldSphere>(Scalar4 *d_pos,
                             Scalar4 *d_vel,
                             Scalar3 *d_accel,
                             unsigned int *d_group_members,
                             const GPUPartition& gpu_partition,
...
template hipError_t gpu_include_rattle_force_nve<ManifoldSphere>(const Scalar4 *d_pos,
                             const Scalar4 *d_vel,
                             Scalar3 *d_accel,
                             Scalar4 *d_net_force,
                             Scalar *d_net_virial,
