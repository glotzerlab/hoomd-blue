...
cmake ../ -DPYTHON_EXECUTABLE=`which python` -DCMAKE_INSTALL_PREFIX=${HOME}/local -DSINGLE_PRECISION=OFF -DENABLE_CUDA=OFF -DBUILD_DEPRECATED=ON -DBUILD_JIT=ON -DBUILD_TESTING=ON -DBUILD_MD=ON -DLLVM_DIR=`which clang`
