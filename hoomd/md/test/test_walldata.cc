...
UP_TEST( construction )
    ...
    UPP_ASSERT(defSphere.inside==true);
    ...
    UPP_ASSERT(Sphere.inside==false);
    ...
    UPP_ASSERT(defCylinder.inside==true);
    ...
    UPP_ASSERT(Cylinder.inside==false);
