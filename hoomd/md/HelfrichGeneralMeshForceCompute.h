...
/*! \file HelfrichGeneralMeshForceCompute.h
...
/*! HelfrichGeneral energy forces are computed on every particle in a mesh.
    ...
    \ingroup computes
*/
class PYBIND11_EXPORT HelfrichGeneralMeshForceCompute : public MeshForceCompute
    {
    public:
    //! Constructs the compute
    HelfrichGeneralMeshForceCompute(std::shared_ptr<SystemDefinition> sysdef,
                             std::shared_ptr<MeshDefinition> meshdef);

    //! Destructor
    virtual ~HelfrichGeneralMeshForceCompute();
...
namespace detail
    {
//! Exports the HelfrichGeneralMeshForceCompute class to python
